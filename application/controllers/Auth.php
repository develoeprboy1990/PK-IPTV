	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				//get user details
				$user_info = $this->ion_auth->user($this->session->user_id)->result();
				
				$role = $this->db->get_where('groups', array('id' => $user_info[0]->role))->row();
        		$role_name = $role->name; 
        		$this->session->set_userdata(array('role'=>$role_name));
		...
		else
		{
			...
			$this->data['identity'] = [
                ...
                'placeholder' => 'Email', //lang('auth_your_email')
                'autocomplete' => 'off'
			];
			...
			$this->data['password'] = [
				...
				'type' => 'password',
				'class'       => 'form-control form-control-solid',
                'placeholder' => 'Password', //lang('auth_your_password')
                'autocomplete' => 'off'
			];
