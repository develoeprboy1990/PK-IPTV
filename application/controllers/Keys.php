...
class Keys extends User_Controller {
	...
	public function index($tab=1){
        ...
        $this->data['subscription_renewal_keys_list_view']= $this->load->view( DEFAULT_THEME . 'keys/_list_subscription_keys',$this->data, TRUE);
		 ...
		 // Master Keys Form and List 
        //$this->data['master_keys']= $this->subscription_renewal_keys_m->getKeys();
		$this->data['master_keys']= $this->subscription_renewal_keys_m->getKeysMaster();
        $this->data['master_keys_view'] = $this->load->view( DEFAULT_THEME . 'keys/_add_master_keys',$this->data, TRUE);
        $this->data['master_keys_list_view']= $this->load->view( DEFAULT_THEME . 'keys/_list_master_keys',$this->data, TRUE);
       ...
       // $this->data['activation_keys']= $this->activation_keys_m->getKeys();
	    $this->data['activation_keys']= $this->subscription_renewal_keys_m->getKeysActivation();
	...
	public function createMasterKeys(){
        ...
        if($this->form_validation->run()==TRUE){
            ...
            redirect(BASE_URL.'keys/index/5');
        }
    ...
    public function createActivationKeysXXX(){
        check_allow('create',$this->data['is_allow']);
        $rules = $this->activation_keys_m->rules;
        $this->form_validation->set_rules($rules);
        if($this->form_validation->run()==TRUE){
