<div class="footer-support-section py-5 bg-light">
    <div class=""><!-- container -->
        <div class="row">
            <!-- Box 1: Questions -->
            <div class="col-md-6 mb-4">
                <div class="card h-100 text-center p-4">
                    <div class="card-body">
                        <img src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/illustrations/29.svg" alt="Questions Icon" class="mb-3" style="max-width: 100px;">
                        <h5 class="card-title">Questions ?</h5>
                        <p class="card-text">Visit our Help Center for detailed assistance on billing, payments, and subscriptions.</p>
                        <a  href="<?php echo BASE_URL;?>customer/profile"  class="btn btn-primary">Go to Help Center</a><!-- href="/help-center" -->
                    </div>
                </div>
            </div>
            <!-- Box 2: Contact Support -->
            <div class="col-md-6 mb-4">
                <div class="card h-100 text-center p-4">
                    <div class="card-body">
                        <img src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/illustrations/31.svg" alt="Contact Support Icon" class="mb-3" style="max-width: 100px;">
                        <h5 class="card-title">Contact Support</h5>
                        <p class="card-text">Need assistance? Contact our support team for prompt, personalized help with your queries & concerns.</p>
                        <a   href="<?php echo BASE_URL;?>customer/profile" class="btn btn-primary">Contact Support</a><!--  href="/contact-support" -->
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="card shadow-none border-0 rounded-0">
		...
		<div class="card-header" id="kt_activities_header">
			<!--<h3 class="card-title fw-bold text-dark">Subscription Logs</h3>-->
			
			<div class="tab" style="margin-top: 13px;">
			  <button class="tablinks active" onclick="openCity(event, 'key_log')" id="defaultOpen" style="color:var(--bs-text-dark);">Subscription Logs</button>
			  <!-- <button class="tablinks" onclick="openCity(event, 'customer_log')" style="color:var(--bs-text-dark);">Wallet Log</button>	 -->	  
			</div>
						...
						<div class="timeline-content mb-10 mt-n1">									
							...
							<div class="overflow-auto pb-5 tabcontent" id="key_log">
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5" style="border-bottom: 1px solid #ccc !important;">
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-275px min-w-200px">Plan Name</span>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="w-175px min-w-100px pe-2">
										<!--<span class="badge badge-light text-muted"></span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-175px min-w-100px">Price</span>
									</div>
									<!--end::Label-->
									<div class="w-175px min-w-100px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-175px min-w-100px">Plan Validity</span>
									</div>
									
									<!--begin::Progress-->
									<!--<div class="w-175px min-w-150px pe-2">
										
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-175px min-w-150px">Device Used</span>
									</div>-->
									<div class="w-300px min-w-150px pe-2">
										<!--<span class="badge badge-light-primary">Device Used</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-300px min-w-150px">Start Date</span>
									</div>
									<div class="w-300px min-w-150px pe-2">
										<!--<span class="badge badge-light-primary">Device Used</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-300px min-w-150px">Expiry Date</span>
									</div>
									<!--end::Progress-->
									<!--begin::Action-->
									<!--<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Expiry</span>-->
								...
								<?php 
									...
									print_r($panel_subscription);*/
								?>		 	
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-100px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="#" class="fs-5 text-dark text-hover-primary fw-semibold w-275px min-w-200px">
									<?php 
										if($val->sebscription_trpe == 'aproduct'){
											echo $all_product['id_'.$val->product_id]['name'].'('.$all_product['id_'.$val->product_id]['plan_name'].')';
										}elseif($val->sebscription_trpe == 'rcode'){
											echo $val->group_name;
										}elseif($val->sebscription_trpe == 'subscript'){
											echo $val->plan_name;
										}else{
											echo $panel_subscription['plans_'.$val->product_activation_key_id]{'name'};
										}
									?>
									</a>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="w-175px min-w-100px pe-2">
										<span class="badge badge-light" style="color:var(--bs-text-dark);">
										<?php 
										if($val->sebscription_trpe == 'aproduct'){
											echo $all_product['id_'.$val->product_id]['price'];
										}elseif($val->sebscription_trpe == 'subscript'){
											echo $all_product['id_'.$val->product_id]['price'];
										}elseif($val->sebscription_trpe == 'rcode'){
											echo $val->monthly_price;
										}else{
											echo $panel_subscription['plans_'.$val->product_activation_key_id]{'monthly_price'}.' / '.$panel_subscription['plans_'.$val->product_activation_key_id]{'month_day'}; 
										}
											?>
										</span>
									</div>
									...
									<div class="w-175px min-w-100px pe-2">
										...
										<?php 
										if($val->sebscription_trpe == 'aproduct'){
											echo $all_product['id_'.$val->product_id]['subscription_length'].' '.$all_product['id_'.$val->product_id]['subscription_days_or_month'];
										}elseif($val->sebscription_trpe == 'rcode'){
											echo $val->length_months.' '.$val->month_day;
										}elseif($val->sebscription_trpe == 'subscript'){
											//echo $val->length_months.' '.$val->month_day;
											echo $all_product['id_'.$val->product_id]['subscription_length'].' '.$all_product['id_'.$val->product_id]['subscription_days_or_month'];
										}else{
											echo $panel_subscription['plans_'.$val->product_activation_key_id]{'length_months'}.' '.$panel_subscription['plans_'.$val->product_activation_key_id]{'month_day'};
										}
										?>
										</span>
									</div>
									...
									<!--<div class="w-175px min-w-150px pe-2">
										<span class="badge badge-light-primary">
											<?php 
												/*if($val->sebscription_trpe == 'aproduct'){
													echo $val->devices_allowed;
												}elseif($val->sebscription_trpe == 'rcode'){
													echo $val->devices_allowed;
												}else{
													echo $panel_subscription['plans_'.$val->product_activation_key_id]{'devices_allowed'};
												}*/
											?>
										</span>
									</div>-->
									...
									<!--end::Label-->
									<div class="w-300px min-w-150px pe-2">
										<span class="badge badge-light" style="color:var(--bs-text-dark);"><?php echo date("M j, Y g:i a", strtotime($val->date_created));?></span>
									</div>
										<!--end::Label-->
									<div class="w-300px min-w-150px pe-2">
										<span class="badge badge-light" style="color:var(--bs-text-dark);"><?php echo date("M j, Y g:i a", strtotime($val->subscription_expire));?></span>
									</div>
									<!--begin::Action-->
							...
							<div class="overflow-auto pb-5 tabcontent" id="customer_log" style="display:none;">
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5" style="border-bottom: 1px solid #ccc !important;">
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Wallet Key</span>
									<!--end::Title-->
									<!--begin::Label-->
									...
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Key used</span>
									</div>										
									
								</div>
								
								<?php 
									foreach($waller_log as $val){
									//print_r($val);
								?>		 	
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px"><?php echo $val->wallet_key;?></a>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="min-w-175px pe-2">
										<span class="badge badge-light" style="color:var(--bs-text-dark);"><?php echo $val->price;?></span>
									</div>
									<!--end::Label-->
									...
									<!--end::Label-->
									<div class="min-w-175px pe-2">
										<span class="badge badge-light" style="color:var(--bs-text-dark);"><?php echo date("M j, Y g:i a", strtotime($val->recharge_date));?></span>
									</div>
