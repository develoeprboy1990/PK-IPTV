...
<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'400px', 'lg': '1000px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
	<div class="card shadow-none border-0 rounded-0">
		<!--begin::Header-->
		<div class="card-header" id="kt_activities_header">
			<!--<h3 class="card-title fw-bold text-dark">Your Logs</h3>-->
			
			
			<div class="tab" style="margin-top: 13px;">
			  <button class="tablinks active" onclick="openCity(event, 'key_log')" id="defaultOpen">Key Create Log</button>
			  <button class="tablinks" onclick="openCity(event, 'customer_log')">Customer Log</button>	
			   <!--<button class="tablinks_status" onclick="openCity(event, 'key_status_log')">Key status Log</button>	-->				  
			</div>
				...
				<div class="timeline">
					...
					<div class="timeline-item">
						...
						<div class="timeline-content mb-10 mt-n1">									
							...
							<div class="overflow-auto pb-5 tabcontent" id="key_log">
								<div style="font-size: 20px;font-weight: bold;margin-bottom: 10px;">Key Log</div>
								<!--begin::Record-->
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-800px px-7 py-3 mb-5" style="border-bottom: 1px solid #ccc !important;">
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Key</span>
									<!--end::Title-->
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Plan Name </span>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="min-w-100px pe-2">
										<!--<span class="badge badge-light text-muted"></span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Price</span>
									</div>
									<!--end::Label-->
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Validity</span>
									</div>
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Created</span>
									</div>
									<!--begin::Progress-->
									<div class="min-w-125px pe-2">
										<!--<span class="badge badge-light-primary">Device Used</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Device Used</span>
									</div>
									<!--end::Progress-->
								...
								<?php 
								/*echo '<pre>';
								print_r($reseller_log);*/
									foreach($reseller_log['key_code'] as $val){
									//print_r($val);
								?>		 	
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-800px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px"><?php echo $val['keycode'];?></a>
									<!--end::Title-->
									<!--begin::Title-->
									<a href="#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px"><?php echo $val['group_name'];?><br>
									Device Used: <span class="badge badge-light-primary"><?php echo $val['devices_allowed'];?></span>
									</a>
									<!--end::Title-->
									
									<!--begin::Label-->
									<div class="min-w-100px pe-2">
										<span class="badge badge-light text-muted"><?php echo '$'.$val['monthly_price'];?></span>
									</div>
									<!--end::Label-->
									<div class="min-w-175px pe-2">
										<span class="badge badge-light text-muted"><?php echo $val['length_months'].' '.$val['month_day'];?></span>
									</div>
										<div class="min-w-175px pe-2">
										<span class="badge badge-light text-muted"><?php echo date("F j, Y, g:i a", strtotime($val['date_created']));?></span>
									</div>
							...
							<!--begin::Timeline details-->
							<div class="overflow-auto pb-5 tabcontent" id="customer_log" style="display:none;">
								<div style="font-size: 20px;font-weight: bold;margin-bottom: 10px;">Customer Log</div>
								<!--begin::Record-->
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-800px px-7 py-3 mb-5" style="border-bottom: 1px solid #ccc !important;">
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-150px min-w-100px">Customer <br>Email</span>
									<!--end::Title-->
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted"></span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-200px ">Plan <br>Name</span>
									</div>
									<!--begin::Label-->
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted"></span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-200px ">Type</span>
									</div>
									<!--end::Label-->
										<!--<span class="badge badge-light text-muted">Validity</span>-->
									<!-- <div class="min-w-150px pe-2">
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px ">Devices Allowed</span>
									</div> -->
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-300px ">Dates</span>
									</div>
									
									<!--begin::Progress-->
									<div class="min-w-125px pe-2">
										<!--<span class="badge badge-light-primary">Device Used</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-100px">Activation<br> Code</span>
									</div>
									<!--end::Progress-->
								...
								/*echo '<pre>';
								print_r($reseller_log);*/
									foreach($reseller_log['user_activate'] as $val){
									//print_r($val);
								?>		 	
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-800px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="<?php echo BASE_URL;?>resellers/editcustomer/<?php echo $val['customer_id'];?>" class="fs-5 text-dark text-hover-primary fw-semibold w-200px min-w-100px"><?php echo $val['customer_email'];?></a>
									<!--end::Title-->
									<div class=" pe-2  w-200px">
										<span class="badge badge-light text-muted"><?php echo $val['plan_name'];?></span>
									</div>
									<!--begin::Label-->
									<div class=" pe-2 w-200px">
										<span class="badge badge-light text-muted"><?php echo $val['sebscription_trpe'];?></span>
										<?php if($val['sebscription_trpe'] == 'Upgrade'){ ?>
											<br>Reamining Amount: <?php echo $val['remaining_balance'];?>
										<?php } ?>
									</div>
									<!--end::Label-->
									<!-- <div class="min-w-150px pe-2">
										<span class="badge badge-light text-muted"><?php echo $val['devices_allowed'];?></span>
									</div> -->
									<div class=" pe-2 w-300px">
											Created: <span class="badge badge-light text-muted"><?php echo date("F j, Y, g:i a", strtotime($val['date_created']));?></span>
										Expire: <span class="badge badge-light text-muted"><?php echo date("F j, Y, g:i a", strtotime($val['subscription_expire']));?></span>
									</div>
									
									<!--begin::Progress-->
									<div class=" pe-2 w-100px">
										<span class="badge badge-light-primary"><?php echo $val['activation_code'];?></span>
									</div>
									<!--end::Progress-->
							...
							<!--begin::Timeline details-->
							<div class="overflow-auto pb-5 tabcontent" id="key_status_log" style="display:none;">
								<div style="font-size: 20px;font-weight: bold;margin-bottom: 10px;">Key status Log</div>
								<!--begin::Record-->
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5" style="border-bottom: 1px solid #ccc !important;">
									<!--begin::Title-->
									<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Plan Name</span>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="min-w-100px pe-2">
										<!--<span class="badge badge-light text-muted"></span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Key Code</span>
									</div>
									<!--end::Label-->
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Key Status</span>
									</div>
									<div class="min-w-175px pe-2">
										<!--<span class="badge badge-light text-muted">Validity</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Status Change Date</span>
									</div>
									<!--begin::Progress-->
									<div class="min-w-125px pe-2">
										<!--<span class="badge badge-light-primary">Device Used</span>-->
										<span class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Reason For status Change</span>
									</div>
									<!--end::Progress-->
								...
								<?php 
								/*echo '<pre>';
								print_r($key_status_log);*/
									foreach($key_status_log as $val){
									//print_r($val);
								?>		 	
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px"><?php echo $val['group_name'];?></a>
									<!--end::Title-->
									<!--begin::Label-->
									<div class="min-w-100px pe-2">
										<span class="badge badge-light text-muted"><?php echo $val['keycode'];?></span>
									</div>
									<!--end::Label-->
									<div class="min-w-175px pe-2">
										<span class="badge badge-light text-muted" style="color:<?php echo ($val['key_status'] == 'Enable') ? '#00cc00  !important;': '#009ef7  !important;' ; ?>"><?php echo $val['key_status'];?></span>
									</div>
										<div class="min-w-175px pe-2">
										<span class="badge badge-light text-muted"><?php echo date("F j, Y, g:i a", strtotime($val['date_status']));?></span>
									</div>
									
									<!--begin::Progress-->
									<div class="min-w-125px pe-2">
										<span class="w-175px min-w-100px"><?php echo $val['reseller_msg'];?></span>
									</div>
									<!--end::Progress-->
...
<script src="<?php echo DEFAULT_ASSETS_CUSTOMER_NEW;?>js/dataTables.js"></script>
<script src="<?php echo DEFAULT_ASSETS_CUSTOMER_NEW;?>js/dataTables.bootstrap5.js"></script>
<style>
.tab {
