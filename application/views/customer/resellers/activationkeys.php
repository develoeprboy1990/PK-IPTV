 <style>
                                    ...
                                    <div class="card mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5 pb-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Activation Keys</span>
										...
										<div id="kt_app_content" class="collapse show" >
											<!--begin::Form-->
											<form class="form" method="post" action="<?php echo site_url('resellers/activationkeys');?>">
												<!--begin::Card body-->
												<div class="card-body  pt-5 pb-5"  >
													...
													<div class="col-lg-5 fv-row">
														<!--begin::Label-->
														<label class="  col-form-label required fw-semibold fs-6">Number of Activation Keys you want to generate for selected plan <a title="How man codes user can generate for this plan" style="cursor:pointer;">(?)</a></label>
														<!--end::Label-->
														<!--begin::Col-->
    ...
    margin-right: -15px;">X</span>	
								...
								<div class="card-header pt-5 pb-5 bg-white">
													<!--begin::Title-->
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">List of Activation Keys</span>
										...
										<div class="card-body py-3">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<tr class="fw-bold text-muted">															
															...
															<th class="min-w-50px">Retail Price</th>
															<th class="min-w-50px">Dealer Price </th>
													...
													?>
														<tr  style="background-color:<?=($today  ==  $dbdate)?'#ecf4e9;':''?> ">
															...
															<td>
															<span class="text-muted fw-semibold text-muted d-block fs-7 card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"  title="Copy Code " > <span  onclick="copyInvoiceNumber('<?php echo $val['keycode'];?>' )" style=" border: 1px solid gray; font-size:15px; border-radius:8px; padding:3px"> &nbsp;&nbsp;  <?php echo $val['keycode'];?>   <i class="fa fa-copy"     ></i> </button></span>
															</span>	</td>
															<td>
																 ...
																 <div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">
																			...
																			if($val['used'] == '0')
																			{?>
                                                                           <span class="badge py-3 px-4 fs-7 badge-light-primary" class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Available">Unused (<?=($today  ==  $dbdate)?'Recently':'Available'?>)</span>
																		   <?php	}else{?>
																			<span style=" cursor:pointer;   "  class="badge py-3 px-4 fs-7 badge-light-danger card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"    title="<?=$val['title'].' '.$val['first_name'].' '.$val['la_name'] ;?>" >Used (<?=($today  ==  $dbdate)?'Recently':'Allocated'?> )</span> 
																			<?php }
															...
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																		<span class="text-muted me-2 fs-7 fw-bold">  <?php echo date("j F, Y, g:i a", strtotime($val['date_created']));?>  </span>
																	</div>
															...
															<td class="text-end">
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex flex-stack mb-2">
																 <?php echo ($val['disabled'] == '1') ? 'OFF' : 'ON';?></span>
																	</div>
																</div>
															</td>
															...
															<li>
																			...
																			<?php if($val['used'] == '0' && $val['dealer_price']!=0) {?>
																				<li><a onclick="return confirm('Are you sure you want to Delete this code ?');"  title="Delete Key" href="<?php echo site_url('resellers/deleteunusedkey/').$val['id']; ?>" class="btn btn-light btn-sm card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" ><i class="fa fa-trash"></i></a>
                                                                  			<?php } ?>
																			</ul>
																 </div>
															</td>
