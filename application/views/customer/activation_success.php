        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <h3 class="text-muted">
                Congratulations! You have successfully activated and registered your product. <br />
                Please Login to check your account.<br />
                <a href="<?=site_url('customer/login')?>">Login</a>
              </h3>
