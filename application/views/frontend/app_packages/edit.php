    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>app_packages/edit/<?php echo $package_detail->id?>" class="form-horizontal">
             ...
             <div class="row"> 
              ...
              <div class="row"> 
                 <input type="hidden" name="total_categories" id="multiselect_right_number"> 
                <div class="form-group">
