    ...
    <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo anchor('publish/updateAll', '<i class="fa fa-plus"></i> Publish All Items', array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
            </div>
                ...
                <tbody>
                  <?php foreach($modules as $module){?>
                    <tr>
                      ...
                      <td>
                        <a href="<?=site_url('publish/create/'. $module['id'])?>" style="text-decoration: underline;">Publish To Cloud</a>
                      </td>
                      <td>
