    ...
    <div class="box">
      ...
      <div class="box-body">
        <div id="ajax_search_responce" class="table-responsive">
          <table id="series_ott_platforms" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>#</th>
                <th>Order</th>
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><a href="javascript:void(0);" class="btn btn-block btn-primary btn-flat" onclick="addItem('1')"><i class="fa fa-plus"></i> Add a Series OTT Platform</a></h3>
      </div>
    </div>
