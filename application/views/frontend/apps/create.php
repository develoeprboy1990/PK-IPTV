    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>apps/create" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <div class="row"> 
                        <div class="form-group">
                          <div class="col-sm-12">
                            ...
                            <div class="col-sm-7">
                              <input type="text" id="url" name="url" value="<?=set_value('url')?>" class="form-control" placeholder="App Name" required/>
