    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>services/create" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row"> 
                <div class="form-group">
                  <label for="available_countries" class="col-sm-2 control-label">Menu Items</label>
                  <div class="col-sm-10">
