                            ...
                            <div class="tab-content">
                              <?php defined('BASEPATH') OR exit('No direct script access allowed');?>
								<div class="box box-primary">
									...
									<?php } ?>
									<div class="box-body">
									  <form method="post" action="<?= BASE_URL ?>reseller/editplanRenewal/<?php echo $id;?>" class="form-horizontal">
										<div class="row"> 
										...
										<div class="row" id="total_price_sub" style="display:block;"> 
										  <div class="form-group">
											<label for="length_months" class="col-sm-2 control-label">Total price</label>
											<div class="col-sm-4">
												<span id="price_amount_sub"><?php echo $price*$length_months; ?></span>
											</div>
										  </div>
										</div>
