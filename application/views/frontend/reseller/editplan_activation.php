                            ...
                            <div class="tab-content">
                              <?php defined('BASEPATH') OR exit('No direct script access allowed');?>
								<div class="box box-primary">
									...
									<?php } ?>
									<div class="box-body">
									  <form method="post" action="<?= BASE_URL ?>reseller/editplanActivation/<?php echo $id;?>" class="form-horizontal">
										<div class="row"> 
										...
										<div class="row"> 
										  <div class="form-group">
											...
											<div class="col-sm-4">
											 <input type="number" id="activation_price_act" name="activation_price" class="form-control" placeholder="100" required value="<?php echo $activation_price;?>">
										...
										<div class="row" id="total_price_act" style="display:block;"> 
										  <div class="form-group">
											<label for="length_months" class="col-sm-2 control-label">Total price</label>
											<div class="col-sm-4">
												<span id="price_amount_act"><?php echo (($price*$length_months)+$activation_price); ?></span>
											</div>
										  </div>
										</div>
