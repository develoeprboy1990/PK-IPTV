                            ...
                            <div class="tab-content">
                              <?php defined('BASEPATH') OR exit('No direct script access allowed');?>
								<div class="box box-primary">
									...
									<?php } ?>
									<div class="box-body">
									  <form method="post" action="<?= BASE_URL ?>reseller/editplanMaster/<?php echo $id;?>" class="form-horizontal">
										<div class="row"> 
										...
										<div class="row"> 
										  <div class="form-group">
											...
											<div class="col-sm-4">
											 <input type="number" id="activation_price_mas" name="activation_price" class="form-control" placeholder="100" required value="<?php echo $activation_price;?>">
											 <span class="text-danger"></span>
											</div>
										  </div>
										</div>  -->
										
										<input type="hidden" id="activation_price_mas" name="activation_price" class="form-control" placeholder="100" required value="<?php echo $activation_price;?>">
											
										<div class="row" id="total_price_mas" style="display:block;"> 
										  <div class="form-group">
											<label for="length_months" class="col-sm-2 control-label">Total price</label>
											<div class="col-sm-4">
												<span id="price_amount_mast"><?php echo (($price*$length_months)+$activation_price); ?></span>
											</div>
										  </div>
										</div>
										...
										<div class="row"> 
										  <div class="form-group">
											...
											<div class="col-sm-4">
											  <input type="submit" class="btn btn-success " name="resellers_plans" value="Update Reseller Plans">
											</div>
										  </div>
										</div>
									  </form>
