     ...
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            ...
            <form method="post" action="<?= BASE_URL ?>series_stores/add/<?=$parent_id?>"  enctype="multipart/form-data" class="form-horizontal">
            <?php }else{?>
             <form method="post" action="<?= BASE_URL ?>series_stores/add"  enctype="multipart/form-data" class="form-horizontal">
            <?php }?>
