        ...
        <?php endif; ?>
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo anchor('series_stores/add', '<i class="fa fa-plus"></i> Add a Store', array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div id="ajax_search_responce" class="table-responsive">
                ...
                <thead>
                  <tr>
                    ...
                    <th>Position</th>
                    <th>Language</th>
                    <th>Total Series</th> <!-- Add this line -->
                    <th>Active</th>
                    <th>Edit</th>
                    <th>Delete</th>
                  </tr> 
