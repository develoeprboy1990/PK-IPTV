    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>devices/create" enctype="multipart/form-data" class="form-horizontal">
              
              <div class="row"> 
                <div class="form-group">
                  <label for="model_name" class="col-sm-2 control-label">Model Name</label>
                  <div class="col-sm-4">
                   <input type="text" id="model_name" name="model_name" class="form-control" value="" placeholder="Model Name"/>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="model_type" name="model_type" class="form-control" value="" placeholder="Model Type"/>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="vat" name="vat" class="form-control" value="" placeholder="VAT"/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <div class="onoffswitch">
                      <input type="checkbox" name="available" class="onoffswitch-checkbox" id="available" value="true">
