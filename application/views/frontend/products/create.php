    ...
    <!-- Main content -->
     <section class="content">
      <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>products/create" enctype="multipart/form-data" class="form-horizontal">
              <div class="row"> 
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">Name</label>
                  <div class="col-sm-4">
                   <input type="text" id="name" name="name" class="form-control" placeholder="Name"  value="<?=set_value('name')?>" required/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" id="publish_start" name="publish_start" value="<?=set_value('publish_start')?>" required>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right"  id="publish_end" name="publish_end" value="<?=set_value('publish_end')?>" required>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                     <select id="gui_setting_id" name="gui_setting_id" class="form-control" required>
                        ...
                        <option value="<?=$setting['id']?>"><?=$setting['setting_name']?></option>
                        <?php }?>
                     </select>
                  </div>
                </div>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <input type="text" id="plan_name" name="plan_name" value="<?=set_value('plan_name')?>" class="form-control" placeholder="Plan Name" required/>
              ...
              <div class="row"> 
                <div class="form-group">
                  <label for="subscription_length" class="col-sm-2 control-label">Subscription Length</label>
                  <div class="col-sm-1">
                   <input type="text" id="subscription_length" name="subscription_length" value="<?=set_value('subscription_length')?>" class="form-control" placeholder="12" required/>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                   <input type="text" id="price" name="price" value="<?=set_value('price')?>" class="form-control" placeholder="15.00" required/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="onoffswitch">
                      <input type="checkbox" name="enable_geo_location" class="onoffswitch-checkbox" id="enable_geo_location" value="1">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <select name="customer_can_change_plan" id="customer_can_change_plan" class="form-control">
                      <option value="1" <?=(set_value($customer_can_change_plan)=="1") ? "selected": ""?>>Yes</option>
                      <option value="0" <?=(set_value($customer_can_change_plan)=="0") ? "selected": ""?>>NO</option>
                    </select>
                  </div>
                </div>
              </div>
