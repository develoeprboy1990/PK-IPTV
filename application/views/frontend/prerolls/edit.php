    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>prerolls/edit/<?php echo $details->id?>" class="form-horizontal">
             <input type="hidden" name="type" value="preroll">
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="length" name="length" class="form-control" value="<?=$details->length?>" placeholder="length"/>
                    ...
                    <div class="panel panel-default" style="background-color:#fff; width: 800px;">
                      <div class="panel-body" >
                         <div class="row">
                          ...
                          <div class="col-sm-5">
                            <select id="multiselect_right_package" class="form-control" name="countries[]" size="15" multiple="multiple">
                                <?php foreach ($countries as $country) { ?>
             ...
             <!--  <div class="row"> 
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <button type="submit" class="btn btn-success ">Update Preroll Video</button>
                  </div>
                </div>
              </div>
            </form>
