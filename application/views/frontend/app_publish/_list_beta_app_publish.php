<div class="box box-primary">
    <div class="box-header">
      ...
      <div class="pull-right">
        ...
        <?php
        $activeRecord = $this->App_publish_m->getActiveRecord('Beta');
        if($activeRecord) {
        ...
        <a href="<?php echo base_url('app_publish/download/Beta'); ?>" class="btn btn-success" target="_blank">
            <i class="fa fa-download"></i> Download General App
        </a>
        <button class="btn btn-primary publish-app" data-type="Beta">
            Publish Beta App
        </button>
      </div>
    </div>
...
<div class="modal fade" id="detailsBetaModal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modalBetaBody">
