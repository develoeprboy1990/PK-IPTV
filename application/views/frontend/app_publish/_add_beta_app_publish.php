...
<div class="box box-primary">
    <div class="box-header"><h4><i class="fa fa-plus"></i> Create Beta App Publish</h4></div>
      ...
      <form method="post" action="<?= BASE_URL ?>app_publish/createAppPublish" class="form-horizontal">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-4">
                  <select id="beta_type" name="beta_type" class="form-control">
                      ...
                      <option value="Beta-Setup Box">Beta-Setup Box</option>
                      <option value="Beta-General">Beta-General</option>
                  </select>
        ...
        <div class="row"> 
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <button type="submit" class="btn btn-success">Create Beta App</button>
            </div>
          </div>
        </div>
      </form>
