<div class="box box-primary">
    <div class="box-header">
      ...
      <div class="pull-right">
        <?php
        $activeRecord = $this->App_publish_m->getActiveRecord('SetUp');
        if($activeRecord) {
        ...
        <a href="<?php echo base_url('app_publish/download/SetUp'); ?>" class="btn btn-success" target="_blank">
            <i class="fa fa-download"></i> Download SetUp App
        </a>
        <button class="btn btn-primary publish-app" data-type="SetUp">
            Publish SetUp App
        </button>
      </div>
    </div>
...
<div class="modal fade" id="detailsSetUpModal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modalSetUpBody">
