    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>overlays/create" enctype="multipart/form-data" class="form-horizontal">
             ...
             <!--  
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <button type="submit" class="btn btn-success ">Add Overlay Video</button>
                  </div>
                </div>
              </div>
            </form>
