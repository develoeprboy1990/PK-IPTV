...
<div class="login-box">
  <div class="login-logo">
    <img src="<?= DEFAULT_ASSETS ?>sunglife_logo.png" alt="User Management System" title="UMS" style="height: 8rem;"><br/>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <br/>
    <div>
        <a href="<?= BASE_URL ?>admin/forgotpassword">I forgot my password</a>
    </div>
