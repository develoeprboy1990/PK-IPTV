    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>tickers/create" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="show_time" name="show_time" class="form-control" placeholder="25"/>
              ...
              <div class="row"> 
                <div class="form-group">
                  <label for="text" class="col-sm-2 control-label">Ticker Text</label>
                  <div class="col-sm-4">
...
<!-- 
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <button type="submit" class="btn btn-success ">Add Ticker Video</button>
                  </div>
                </div>
              </div>
            </form>
