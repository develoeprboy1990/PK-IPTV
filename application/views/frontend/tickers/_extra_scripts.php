<script type="text/javascript">
    $(document).ready(function(){
        ...
        setTimeout(function(){ 
          $('.sidebar-menu li.#menu-advertisements').toggle()},100);
          //$('.sidebar-menu li.#menu-advertisements')[0].click()}, 100);
      
          $('#menu-advertisements').click(function() {
              $('#menu-advertisements .treeview-menu').attr('display','block');
          });
