    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?= BASE_URL ?>tickers/edit/<?php echo $details->id?>" class="form-horizontal">
             <input type="hidden" name="type" value="ticker">
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea id="text" name="text" class="form-control"><?=$details->text?></textarea>
             ...
             <!--  <div class="row"> 
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <button type="submit" class="btn btn-success ">Update Ticker Video</button>
                  </div>
                </div>
              </div>
            </form>
