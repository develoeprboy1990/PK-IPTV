...
<div class="box box-primary">
    <div class="box-header"><h4><i class="fa fa-plus"></i> Create Renewal Keys</h4></div>
    <?php if($responce = $this->session->flashdata('success')){ ?>
        <div class="alert alert-warning" role="alert" style="text-align:center"><?php echo $responce;?></div>
    <?php } ?>
    <div class="box-body">
      <form method="post" action="<?= BASE_URL ?>keys/createRenewalKeys" class="form-horizontal">
        <div class="row"> 
       ...
       <!-- <div class="row"> 
		...
		<div class="row"> 
          <div class="form-group">
            ...
            <div class="col-sm-4">
             <input type="number" id="monthly_price_sub" name="monthly_price" class="form-control" placeholder="50" required/>
             <span class="text-danger"><?php echo form_error('quantity'); ?></span>
            </div>
          </div>
        </div>
        <div class="row"> 
          <div class="form-group">
            ...
            <div class="col-sm-2">
             <input type="number" id="length_months_sub" name="length_months" class="form-control" placeholder="12" required/>
        ...
        <div class="row"> 
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <button type="submit" class="btn btn-success ">Create Renewal Keys</button>
            </div>
          </div>
        </div>
      </form>
