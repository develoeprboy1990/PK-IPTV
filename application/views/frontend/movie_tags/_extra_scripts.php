<script type="text/javascript">
  $(document).ready(function(){
    ...
    function updateItem(id){
        ...
        $.ajax({ // AJAX request
             type: 'POST',
             url: '<?= BASE_URL ?>movie_tags/updateItem',
    ...
    function addItem(){
      ...
      var latest_row_id = $('#tags tr:last').attr('id');
    ...
    function add(id){
        ...
        $.ajax({ // AJAX request
             type: 'POST',
             url: '<?= BASE_URL ?>movie_tags/addItem',
             data: { id: id , name: name},
             beforeSend: function() {
                $(this).html('Updating...');
             },
    ...
    function cancelUpdate(id){
      ...
      $.ajax({ // AJAX request
               type: 'POST',
               url: '<?= BASE_URL ?>movie_tags/getItem',
               data: { id: id },
               success: function(response) {
    ...
    function deleteItem(id){
        ...
        if (result) {
          $.ajax({ // AJAX request
               type: 'POST',
               url: '<?= BASE_URL ?>movie_tags/deleteItem',
               data: { id: id },
               beforeSend: function() {
                  $(this).html('Deleting...');
               },
