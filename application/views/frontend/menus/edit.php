    ...
    <!-- Main content -->
     <section class="content">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="<?=BASE_URL?>menus/edit/<?php echo $details->id?>" class="form-horizontal">
             ...
             <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="name" name="name" value="<?php echo $details->name?>" class="form-control" placeholder="Name"/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <select name="type" class="form-control" id="type">
                      ...
                      <option value="full" <?=($details->type=='full') ? "selected": ""?>>Full</option>
                   </select>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="onoffswitch">
                      <label>
                        <input type="radio" name="is_default" id="is-default-1" value="yes" class="flat-red" <?=($details->is_default=='yes') ? "checked": ""?>>  
                      </label>
                      <label for="is-default-1" class="" style="font-size:14px;">Yes</label>
                      <label>
                        <input type="radio" name="is_default" id="is-default-2" value="no" class="flat-red"  <?=($details->is_default=='no') ? "checked": ""?>> 
                      </label>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <label>
                      <input type="radio" name="is_module" id="is-module-1" value="no" class="flat-red"  <?=($details->is_module=='no') ? "checked": ""?>>  
                    </label>
                    <label for="is-module-1" class="" style="font-size:14px;">No</label>
                    <label>
                      <input type="radio" name="is_module" id="is-module-2" value="yes" class="flat-red" <?=($details->is_module=='yes') ? "checked": ""?>> 
                    </label>
              ...
              <div class="row" id="module-name-box"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="text" id="module_name" name="module_name" class="form-control" value="<?php echo $details->module_name?>" placeholder="Module Name"/>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="onoffswitch">
                      <label>
                        <input type="radio" name="is_app" id="is-app-1" value="no" class="flat-red" <?=($details->is_app=='no') ? "checked": ""?>>  
                      </label>
                      <label for="is-app-1" class="" style="font-size:14px;">No</label>
                      <label>
                        <input type="radio" name="is_app" id="is-app-2" value="yes" class="flat-red" <?=($details->is_app=='yes') ? "checked": ""?>> 
                      </label>
              ...
              <div class="row"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="onoffswitch">
                      <input type="checkbox" name="active" class="onoffswitch-checkbox" id="active" value="1" <?=($details->active==1) ? "checked": ""?>/>
